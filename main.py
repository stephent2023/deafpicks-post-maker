...
class DP_Postmaker(ttk.Frame):
    ...
    def generate_slide_3(self):
        ...
        album_num_of_words = len(self.album_name.split())
        print(album_num_of_words)
        ...
        while printing_title == True:
            ...
            # if one word title
            if len(self.album_name.split()) == 1:
